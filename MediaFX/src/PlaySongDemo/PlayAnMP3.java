...
public class PlayAnMP3 extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		// I changed the song to be played to DanseMacabreViolinHook
		...
		Scene scene = new Scene(pane, 300, 50); // changed to 300 pixels wide, 50 pixels tall
